...
# compiler=wine ~/68000/a68k.exe %f -o%e.hex -s -n -rmal


[build-menu]
FT_00_LB=Assemble
FT_00_CM=wine ~/68000/a68k.exe "%f" -o"%e.hex" -s -n -rmal
FT_00_WD=%d
EX_00_LB=_Execute
EX_00_CM=~/68000/d68k.sh "%e.hex"; exit
EX_00_WD=%d
